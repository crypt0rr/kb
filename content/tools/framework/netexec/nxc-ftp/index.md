...
```plain
nxc ftp [-h] [-id CRED_ID [CRED_ID ...]] [-u USERNAME [USERNAME ...]] [-p PASSWORD [PASSWORD ...]] [--ignore-pw-decoding] [-k] [--no-bruteforce] [--continue-on-success] [--use-kcache] [--log LOG]
               ...
               [--server {http,https}] [--server-host HOST] [--server-port PORT] [--connectback-host CHOST] [--port PORT] [--ls]
               target [target ...]
```
